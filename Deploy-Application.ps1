...
Try {
	...
	[string]$appVendor = 'Axon Enterprise'
	[string]$appName = 'Axon View XL'
	[string]$appVersion = '1.16.1'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '2022.10.21'
	...
	$CloseApps = "Axon Fleet=Axon View XL"

	##* Application install parameters.
	# 64-bit application
	# Application install Path.
	$64bitAppInstallPath = "$PSScriptRoot\Files\VIEW XL Direct Download.exe"
	# Application  install parameters.
	$64bitAppInstallParam = "/install /norestart /quiet"
	...
	$RemoveAppNamesEXE = @("Axon View XL")

	##* Application uninstall parameters.
	# 64-bit application
	# Application uninstall path.
	$64bitAppUninstallPath = "$PSScriptRoot\Files\VIEW XL Direct Download.exe"
	# Application uninstall parameters.
	$64bitAppUninstallParam = "/uninstall /norestart /quiet"
